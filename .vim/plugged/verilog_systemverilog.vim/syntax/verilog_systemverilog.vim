...
syn keyword verilogNumber   	int longint shortint write read randomize
...
syn match 	verilogUvm		 			"\s*uvm_\w*"     containedin=ALLBUT,verilogComment,verilogMacro,verilogString,verilogNot
syn match 	verilogUvm		 			"\s*cdn[A-Z]\w*" containedin=ALLBUT,verilogComment,verilogMacro,verilogString,verilogNot
syn match 	verilogUvm		 			"\s*\w\w*_c\s"   containedin=ALLBUT,verilogComment,verilogString
syn match 	verilogMacro				"`\w\w*"         containedin=ALLBUT,verilogComment,verilogNot
...
syn match 	verilogNot					"\[[a-z$1-9_]*\]"  containedin=ALLBUT,verilogComment,verilogStatement
syn match 	verilogMethod    			"\s\w\w*_\w\w*\s*("  containedin=ALLBUT,verilogComment,verilogStatement
